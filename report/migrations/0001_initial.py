    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='report.Member')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='report.Member')),
                ('tx', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='report.Transaction')),
            ],
            options={
                'db_table': 'fee_entry',
                'managed': True,
